...
void DataMC::plotHist(TH1F *h1,TH1F *h2,TH1F *hnp,TCanvas *c,std::string Region="",std::string h1R="",std::string h2R="",std::string variable=""){
    ...
    std::string plotstring=variable+"_"+"_"+h1R+"_"+h2R+"_";
    ...
    TPaveText *tpav_txt = new TPaveText(0.57043478,0.648342,0.8652174,0.9210471,"brNDC");
    ...
    double scaleFactor=225.5;//h1->Integral()/(h2->Integral()+hnp->Integral());
   // h2->Scale(scaleFactor);
   // hnp->Scale(scaleFactor);
    cout<<"Data/MC: "<<h1->Integral()/(h2->Integral())<<endl;  
